...
import { savePromoCode, getPromoCode} from "../utils/AsyncStorageHelper";
        ...
        <ScrollView>
          ...
          >
            ...
            <TouchableOpacity
             ...
             onPress={()=>{
               if(this.state.edValue!==""){
                 alert("you have already embedded a coupon on this checkout")
               }
               else{
                AsyncStorage.setItem("promoCode", JSON.stringify(this.state.edValue)).then(
                  success => console.log("oh"),
                  err => console.log("wow")
                );
               }
