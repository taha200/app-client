...
class MyOrderContainer extends React.Component {
  ...
  itemHeader(orderData, index, isShow,time) {
    ...
    if (this.arrayUpcoming != undefined && this.arrayUpcoming.length > 0) {
      return (
        <View style={{ flex: 1 }}>
          ...
          {(this.arrayUpcoming[index].data[0].order_status==="Driver")?
             <View
             style={{
               flex: 1,
               marginTop: 5,
           ...
           >
             ...
             >
              Waiting For The Driver Acceptance
             </Text>
             ...
             {/* <Text /> */}
             <ActivityIndicator size="small" color="#4464ac" />
        ...
        null
          ...
          <View style={{ flex: 1 }}>
            {this.arrayUpcoming[index].data[0].order_status === "OnGoing" ?
                    ...
                    this.arrayUpcoming.length > 0 ? (
                      <SectionList
                        ...
                        renderSectionHeader={({
                          ...
                          return title != "" ? (
                            this.itemHeader(title, index, isShow,this.state.time)
                          ) : (
                              <View />
                            );
                        }}
