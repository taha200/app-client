  ...
  constructor(props) {
    ...
    (this.arrayFinalSideMenu = []),
      (this.sideMenuData = {
        ...
        icons: [
          asse.home_deselect,
          asse.recipe_deselect,
          asse.order_deselect,
          asse.eventbooking_deselect,
          asse.mybooking_deselect,
          asse.notification_deselect,
          asse.rateus_deselect,
          asse.shareus_deselect,
          asse.privacypolicy_deselect,
          asse.aboutus_deselect,
          asse.contactus_deselect,
          this.props.userToken != undefined
            ? asse.signout_deselect
            : undefined
        ],
        iconsSelected: [
          asse.home_select,
          asse.recipe_select,
          asse.order_select,
          asse.eventbooking_select,
          asse.mybooking_select,
          asse.notification_select,
          asse.rateus_select,
          asse.shareus_select,
          asse.privacypolicy_select,
          asse.aboutus_select,
          asse.contactus_select,
          this.props.userToken != undefined ? asse.signout_select : undefined
        ]
      });
  }
    ...
    getUserToken(
      success => {
        ...
        this.setState({
          ...
          // image: userObj.image || asse.user_placeholder
          image: userObj.image
        });
      },
      failure => {}
