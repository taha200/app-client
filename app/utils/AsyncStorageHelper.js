...
export function savePromoCode(val,onSuccess,onFailure){
  AsyncStorage.setItem("promoCode", JSON.stringify(val)).then(
    success => onSuccess(success),
    err => onFailure(err)
  );
}
export function getPromoCode(onSuccess,onFailure){
